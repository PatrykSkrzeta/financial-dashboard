...
date_picker_to = DatePicker(title="End Date", value="2020-01-01", min_date="2000-01-01", max_date=dt.datetime.now().strftime("%Y-%m-%d"))
indicator_choice = MultiChoice(options=["100 day SMA", "30 day SMA", "Linear Regression Line"])

load_button = Button(label="Load Data", button_type="success")
load_button.on_click(lambda event: on_button_click(stock1_text.value, stock2_text.value,
